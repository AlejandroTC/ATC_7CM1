...
strong_correlations = correlation_matrix['diagnosis'][abs(correlation_matrix['diagnosis']) > 0.5].index
...
def train_logistic_regression(X, y, learning_rate=0.01, max_iterations=1, convergence_criterion=0.0001):
...
predictions = [predict(x, W_trained) for x in X_test]
